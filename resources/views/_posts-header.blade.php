<header class="max-w-xl mx-auto mt-20 text-center" xmlns:a="http://www.w3.org/1999/html">
    <h1 class="text-4xl">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div x-data="{show: false}">
            ...
            <div x-show="show" class="py-2 absolute w-32 z-50 style=">
                <a href="/" class="block text-left px-3 text-xm leading-6 hover:bg-gray-300 focus:bg-gray-300">One</a>
